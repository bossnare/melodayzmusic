...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 h-dvh bg-gradient-to-br dark:from-primary/10 dark:via-card/4 dark:to-ring/10 from-primary/20 via-card/8 to-ring/20">
      <Image
        ...
        height={1000}
      />
      <span className="text-xl font-bold select-none hover:text-foreground/90 text-foreground dark:text-primary-foreground lg:text-2xl font-poppins">
        MelodayzMusic
      </span>
