...
export const ContentStream = () => {
  ...
  return (
    <section className="pt-10 pb-60 md:pb-50">
      <h2 className="flex items-center gap-2 mb-4 text-3xl font-poppins font-bold sm:px-1 md:text-3xl">
      ...
      *:bg-gray-100 dark:*:bg-gray-900 gap-4 *:rounded-full"
      ...
      <h3 className="mb-4 text-3xl font-poppins font-bold">Tube</h3>
