  ...
  return (
    <Card className="p-0 bg-transparent border-none rounded-none">
      ...
      <CardFooter className="flex flex-col items-start gap-2 p-0">
        <CardTitle className="w-full capitalize truncate line-clamp-1 text-base lg:text-sm">
          {song.title}
        </CardTitle>
        <CardDescription className="flex flex-col justify-between w-full gap-2 sm:gap-0 sm:flex-row sm:items-center">
          ...
          truncate transition-colors duration-100 ease-in cursor-pointer select-none hover:text-foreground text-sm lg:text-xs line-clamp-1"
          >
            {song.artist}
          </span>
        </CardDescription>
