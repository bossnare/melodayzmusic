...
const VibeCard = ({ song }: SongProps) => {
  ...
  return (
    <WhileTapMotion>
      <Card className="p-0 bg-transparent border-none rounded-none shadow-none cursor-pointer active:opacity-80 font-montserrat lg:hover:bg-muted/30 active:bg-accent/50">
