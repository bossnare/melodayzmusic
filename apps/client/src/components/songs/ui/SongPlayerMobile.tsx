  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        key={'PlayerMobile'}
        className="fixed w-[96%] overflow-hidden rounded-lg left-[2%] h-20 lg:hidden bottom-17 bg-gradient-to-br from-secondary/80 via-secondary to-secondary/70 backdrop-blur-sm"
      >
