  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        key={'PlayerMobile'}
        className="fixed w-[98%] md:w-[70%] md:left-[15%] overflow-hidden rounded left-[1%] h-16 lg:hidden bottom-[65px] bg-gradient-to-br from-[#f7f7f7]/90 to-[e9e9e9]/90 dark:from-[#2b2b2b]/80 dark:to-[#1a1a1a]/80 backdrop-blur-sm"
      >
        <section className="relative flex items-center gap-2 px-2 py-1 size-full font-montserrat">
          {/* grain */}
          <span
            className="absolute rounded invert dark:invert-0 inset-0 opacity-10 pointer-events-none 
