  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        key={'PlayerMobile'}
        className="fixed w-[96%] md:w-[70%] md:left-[15%] overflow-hidden rounded left-[2%] h-16 lg:hidden bottom-[65px] bg-gradient-to-br from-[#f7f7f7]/90 to-[e9e9e9]/90 dark:from-[#2b2b2b]/80 dark:to-[#1a1a1a]/80 backdrop-blur-sm"
      >
