...
export const DashboardHomeSkeleton = () => {
  return (
    <div className="pb-20 space-y-16 lg:space-y-16 pt-10">
      {/* Title */}
      ...
      {/* Grid Skeleton */}
      <div>
        <Skeleton className="w-30 h-6 mb-2 lg:mb-3 rounded-xl bg-foreground/30" />
        <div
      ...
      <div>
        <Skeleton className="h-6 mb-2 w-35 lg:mb-3 rounded-xl bg-foreground/30" />
        <div
