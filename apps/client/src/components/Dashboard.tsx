...
export const Dashboard = () => {
  ...
  return (
    <section className="pt-10 pb-20 bg-gray-50 sm:px-6 md:px-4">
      <h2 className="px-2 pb-2 text-lg font-bold sm:text-2xl md:text-xl lg:text-4xl">
        Discover
      </h2>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">
        {songs.map((song: any) => (
