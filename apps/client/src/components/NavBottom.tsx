...
export const NavBottom = () => {
  ...
  return (
    <nav className="sticky bottom-0 left-0 right-0 flex items-center justify-center w-full gap-6 px-2 text-sm border-t z-6 border-t-gray-200 dark:border-t-gray-800 md:text-base sm:px-0 h-18 md:h-14 bg-gray-50 dark:bg-gray-950 md:gap-5 md:py-5 lg:gap-2">
