...
export const NavBottom = () => {
  return (
    <ul className="flex items-center justify-center gap-1 py-1 transition-all duration-300 ease-in-out md:py-2 lg:hidden bg-gradient-to-r dark:from-nav via-primary/10 dark:via-primary/6 dark:to-nav from-background to-background pb-10 md:pb-2">
      {navLabels.map((tab) => (
        <li
