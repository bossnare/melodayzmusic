...
export const NavBottom = () => {
  return (
    <ul className="flex items-center justify-center gap-1 py-2 transition-all duration-300 ease-in-out lg:hidden bg-gradient-to-r dark:from-nav via-primary/10 dark:via-primary/6 dark:to-nav from-background to-background h-full">
      {navLabels.map((tab) => (
        <li
