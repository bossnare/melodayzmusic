  ...
  return (
    <>
      <button
        ...
        className={cn(
          isActive
            ? 'lg:bg-gradient-to-r lg:from-foreground/4 lg:via-foreground/8 lg:to-foreground/4 text-foreground lg:w-full'
            : 'hover:text-foreground/50 text-muted-foreground lg:w-auto',
      ...
      >
        <MotionTab>
          {isPending && !isActive ? (
            <Loader className="border-foreground/90 size-6" />
          ) : (
            <Icon
