    ...
    <>
      <button
        ...
        className={cn(
          ...
          'select-none flex flex-col p-1 md:p-2 w-[75%] md:w-[50%] active:rounded-lg lg:active:w-full active:bg-primary/14 font-semibold text-xs lg:text-sm rounded-sm items-center font-montserrat justify-center gap-1 md:gap-2 md:flex-row lg:justify-start'
        )}
      >
        <MotionTab>
          {isPending && !isActive ? (
